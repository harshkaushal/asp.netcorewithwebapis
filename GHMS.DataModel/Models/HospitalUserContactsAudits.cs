...
{
    public class HospitalUserContactsAudits : BaseAuditsDBModel
    {
        [Key]
        ...
        public Int64 HospitalUserContactsId { get; set; }
        public HospitalUserContacts HospitalUserContacts { get; set; }
